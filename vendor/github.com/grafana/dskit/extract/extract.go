...
func MetricNameFromLabelAdapters(labels []dskitpb.LabelAdapter) (string, error) {
...
func UnsafeMetricNameFromLabelAdapters(labels []dskitpb.LabelAdapter) (string, error) {
