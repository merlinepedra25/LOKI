...
// TLSClientConfig is the config for client TLS.
...
func (cfg *TLSClientConfig) RegisterFlagsWithPrefix(prefix string, f *flag.FlagSet) {
...
func (cfg *TLSClientConfig) GetTLSConfig() (*tls.Config, error) {
	config := &tls.Config{
...
func (cfg *TLSClientConfig) GetGRPCDialOptions(enabled bool) ([]grpc.DialOption, error) {
	if !enabled {
