...
func newLabelNameTooLongError(series []dskitpb.LabelAdapter, labelName string) ValidationError {
...
func newLabelValueTooLongError(series []dskitpb.LabelAdapter, labelValue string) ValidationError {
...
func newInvalidLabelError(series []dskitpb.LabelAdapter, labelName string) ValidationError {
	return &genericValidationError{
...
func newDuplicatedLabelError(series []dskitpb.LabelAdapter, labelName string) ValidationError {
	return &genericValidationError{
...
func newLabelsNotSortedError(series []dskitpb.LabelAdapter, labelName string) ValidationError {
	return &genericValidationError{
...
func newTooManyLabelsError(series []dskitpb.LabelAdapter, limit int) ValidationError {
...
func (e *tooManyLabelsError) Error() string {
	return fmt.Sprintf(
		...
		len(e.series), e.limit, dskitpb.FromLabelAdaptersToMetric(e.series).String())
}
...
type exemplarValidationError struct {
	message        string
	seriesLabels   []dskitpb.LabelAdapter
	exemplarLabels []dskitpb.LabelAdapter
	timestamp      int64
}

func (e *exemplarValidationError) Error() string {
	return fmt.Sprintf(e.message, e.timestamp, dskitpb.FromLabelAdaptersToLabels(e.seriesLabels).String(), dskitpb.FromLabelAdaptersToLabels(e.exemplarLabels).String())
}

func newExemplarEmtpyLabelsError(seriesLabels []dskitpb.LabelAdapter, exemplarLabels []dskitpb.LabelAdapter, timestamp int64) ValidationError {
...
func newExemplarMissingTimestampError(seriesLabels []dskitpb.LabelAdapter, exemplarLabels []dskitpb.LabelAdapter, timestamp int64) ValidationError {
	return &exemplarValidationError{
...
func newExemplarLabelLengthError(seriesLabels []dskitpb.LabelAdapter, exemplarLabels []dskitpb.LabelAdapter, timestamp int64) ValidationError {
	return &exemplarValidationError{
		message:        labelLenMsg,
		seriesLabels:   seriesLabels,
		exemplarLabels: exemplarLabels,
...
func formatLabelSet(ls []dskitpb.LabelAdapter) string {
