...
import (
	...
	"github.com/grafana/dskit/storage/bucket/azure"
	"github.com/grafana/dskit/storage/bucket/filesystem"
	"github.com/grafana/dskit/storage/bucket/gcs"
	"github.com/grafana/dskit/storage/bucket/s3"
	"github.com/grafana/dskit/storage/bucket/swift"
...
func (cfg *Config) Validate() error {
	if !stringutil.StringsContain(cfg.supportedBackends(), cfg.Backend) {
