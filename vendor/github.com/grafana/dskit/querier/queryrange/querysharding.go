...
import (
	...
	"github.com/grafana/dskit/querier/lazyquery"
...
func (ast *astMapperware) Do(ctx context.Context, r Request) (Response, error) {
	...
	shardSummer, err := astmapper.NewShardSummer(int(conf.RowShards), astmapper.VectorSquasher, ast.shardedQueriesCounter, ast.logger)
	if err != nil {
		return nil, err
	}
