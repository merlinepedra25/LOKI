...
func NewTripperware(
	...
	activeUsers := cleanupusers.NewActiveUsersCleanupWithDefaultValues(func(user string) {
		err := labels.DeleteMatchingLabels(queriesPerTenant, map[string]string{"user": user})
		if err != nil {
